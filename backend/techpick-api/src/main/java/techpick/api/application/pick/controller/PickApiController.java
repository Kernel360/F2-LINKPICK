...
public class PickApiController {
	...
	public ResponseEntity<PickApiResponse> getPickUrl(@Parameter(hidden = true) @LoginUserId Long userId,
	...
	public ResponseEntity<PickApiResponse> getPick(@Parameter(hidden = true) @LoginUserId Long userId,
	...
	public ResponseEntity<PickApiResponse> savePick(@Parameter(hidden = true) @LoginUserId Long userId,
	...
	public ResponseEntity<PickApiResponse> updatePick(@Parameter(hidden = true) @LoginUserId Long userId,
